<template>
    <v-footer color="#333333" class="pa-4">
      <v-container>
        ...
        <v-row>
          ...
          <v-col cols="12" md="4">
            <h3 class="text-white text-uppercase">Síguenos</h3>
            <div class="d-flex justify-center">
              ...
              <v-btn icon href="https://www.twitter.com" class="mx-2">
                <v-icon color="white">mdi-twitter</v-icon>
              </v-btn>
            </div>
          </v-col>
  
          <!-- Tercera fila: Repositorio -->
          <v-col cols="12" md="4">
            <h3 class="text-white text-uppercase">Repositorio</h3>
        ...
        <!-- Fila inferior: Derechos reservados -->
        <v-row>
          <v-col class="text-center">
            <small class="text-white">&copy; 2024 Nombre de tu E-commerce. Todos los derechos reservados.</small>
          </v-col>
        </v-row>
      </v-container>
    </v-footer>
